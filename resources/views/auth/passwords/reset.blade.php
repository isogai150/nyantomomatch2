      ...
      <form action="{{ route('password.update') }}" method="POST" novalidate>
        ...
        <div class="form-group">
          ...
          <input type="password" class="textbox" id="password_confirmation" name="password_confirmation" placeholder="確認のため再度パスワードを入力してください">
            ...
            @csrf
            @method('POST')
<button onclick="clickEvent()" class="botten">パスワードを更新</button>
{{-- <button type="button" class="botten" onclick="alert('パスワード再設定が完了しました。'); window.location.href='/login';">パスワードを更新</button> --}}
      </form>
