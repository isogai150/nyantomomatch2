        ...
        <div id="tab-conditions" class="tab-content active" role="tabpanel">
            <div class="box">
                ...
                <div class="firstitem">
                    <h3>重要事項</h3>
                    <ul class="list">
                        <li>終生飼育をお約束いただける方にのみ譲渡いたします</li>
                        <li>定期的な健康診断と予防接種を実施してください</li>
                        <li>完全室内飼育にて脱走防止対策を徹底してください</li>
                        <li>飼育困難時は必ず譲渡者に相談してください</li>
                    </ul>
                </div>
                ...
                <h3>譲渡費用</h3>
                <p>{{ number_format($pair->post->cost) }}円（別途手数料と消費税がかかります）</p>
